...
class FunctionalLocators:
    ...
    CLOSE_INGREDIENT_BUTTON = (By.XPATH, "//button[contains(@class, 'Modal_modal__close_modified')]")
    CLOSE_MODAL = (By.XPATH, "//button[contains(@class, 'Modal_modal__close_modified')]")
    ORDER_BASKET = (By.XPATH, ".//ul[contains(@class,'BurgerConstructor_basket__list']")
    COUNT_INGREDIENT = (By.XPATH, ".//p[contains(@class,'counter_counter__num')]")
